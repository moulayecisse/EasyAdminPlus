...
namespace Cisse\EasyAdminPlusBundle\Acl\EventListener;
...
use Cisse\EasyAdminPlusBundle\Acl\Security\AdminAuthorizationChecker;
...
class EasyAdminSubscriber implements EventSubscriberInterface
{
    ...
    public static function getSubscribedEvents()
    {
        ...
        return array(
            /*
             * Removed in CisseEasyAdminPlus 1.0, roles are now part of EasyAdmin!
             *
             * See:
