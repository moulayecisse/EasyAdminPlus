...
namespace Cisse\EasyAdminPlusBundle\Generator;
...
use Cisse\EasyAdminPlusBundle\Generator\Helper\PropertyClassHelper;
use Cisse\EasyAdminPlusBundle\Generator\Helper\PropertyTypeHelper;
use Cisse\EasyAdminPlusBundle\Generator\Model\Entity;
...
class GeneratorTool
{
    ...
    public function initTranslation(string $fileName, string $projectDir, string $userLocale): void
    {
        if (null === self::$translation) {
            ...
            self::$translation->addResource('yaml', $projectDir.'/vendor/cisse/easyadmin-plus-bundle/src/Resources/translations/'.$fileName.'.'.$userLocale.'.yaml', $userLocale);
        }
    }
