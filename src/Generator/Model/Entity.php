...
namespace Cisse\EasyAdminPlusBundle\Generator\Model;

use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Persistence\Mapping\ClassMetadata;
use Cisse\EasyAdminPlusBundle\Generator\Exception\RuntimeCommandException;
use Cisse\EasyAdminPlusBundle\Generator\Property\PropertyConfig;
use Cisse\I18nBundle\Traits\TranslatableEntity;
...
class Entity
{
    ...
    private function initProperties(): void
    {
        ...
        $translatableEntityClassName = 'Cisse\I18nBundle\Traits\TranslatableEntity';
